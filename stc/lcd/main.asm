...
;	main.c:4: LCD_Init();
	lcall	_LCD_Init
;	main.c:5: LCD_ShowChar(1, 1, 'h');
	mov	_LCD_ShowChar_PARM_2,#0x01
	mov	_LCD_ShowChar_PARM_3,#0x68
	mov	dpl,#0x01
	lcall	_LCD_ShowChar
;	main.c:6: LCD_ShowString(1, 3, "cxldada");
	mov	_LCD_ShowString_PARM_3,#___str_0
	mov	(_LCD_ShowString_PARM_3 + 1),#(___str_0 >> 8)
	mov	(_LCD_ShowString_PARM_3 + 2),#0x80
	mov	_LCD_ShowString_PARM_2,#0x03
	mov	dpl,#0x01
