      ...
      00007D 22               [24]  396 	ret
                                    ...
                                    399 ;------------------------------------------------------------
                                    400 ;	button2.c:3: void main() {
                                    401 ;	-----------------------------------------
                                    402 ;	 function main
                                    403 ;	-----------------------------------------
      00007E                        404 _main:
                                    405 ;	button2.c:4: while (1) {
      00007E                        406 00107$:
                                    407 ;	button2.c:5: if (P3_1 == 0) {
      00007E 20 B1 FD         [24]  408 	jb	_P3_1,00107$
                                    409 ;	button2.c:6: delay(20);
      000081 90 00 14         [24]  410 	mov	dptr,#0x0014
      000084 12 00 62         [24]  411 	lcall	_delay
                                    412 ;	button2.c:7: while (P3_1 == 0) {
      000087                        413 00101$:
      000087 30 B1 FD         [24]  414 	jnb	_P3_1,00101$
                                    415 ;	button2.c:9: delay(20);
      00008A 90 00 14         [24]  416 	mov	dptr,#0x0014
      00008D 12 00 62         [24]  417 	lcall	_delay
                                    418 ;	button2.c:10: P2_0 = P2_0 == 1 ? 0 : 1;
      000090 B2 A0            [12]  419 	cpl	_P2_0
                                    420 ;	button2.c:13: }
      000092 80 EA            [24]  421 	sjmp	00107$
                                    422 	.area CSEG    (CODE)
                                    423 	.area CONST   (CODE)
                                    424 	.area XINIT   (CODE)
