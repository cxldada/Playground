      ...
      000003 02 00 B3         [24]  349 	ljmp	_main
      ...
      00006B BE FF 01         [24]  382 	cjne	r6,#0xff,00134$
      00006E 1F               [12]  383 	dec	r7
      00006F                        384 00134$:
      00006F EC               [12]  385 	mov	a,r4
      000070 4D               [12]  386 	orl	a,r5
      000071 60 0A            [24]  387 	jz	00110$
                                    388 ;	../include/tools.h:10: while (--j)
      000073 7D EF            [12]  389 	mov	r5,#0xef
      000075 7C 02            [12]  390 	mov	r4,#0x02
      000077                        391 00101$:
      000077 DD FE            [24]  392 	djnz	r5,00101$
                                    393 ;	../include/tools.h:12: } while (--i);
      000079 DC FC            [24]  394 	djnz	r4,00101$
      00007B 80 E9            [24]  395 	sjmp	00107$
      00007D                        396 00110$:
      ...
      00007E 7F 01            [12]  410 	mov	r7,#0x01
                                    411 ;	led.c:5: while (i != 0) {
      000080                        412 00101$:
      000080 EF               [12]  413 	mov	a,r7
      000081 60 15            [24]  414 	jz	00104$
                                    415 ;	led.c:6: P2 = 0xff & (~i);
      000083 EF               [12]  416 	mov	a,r7
      000084 F4               [12]  417 	cpl	a
      000085 F5 A0            [12]  418 	mov	_P2,a
                                    419 ;	led.c:7: delay(100);
      000087 90 00 64         [24]  420 	mov	dptr,#0x0064
      00008A C0 07            [24]  421 	push	ar7
      00008C 12 00 62         [24]  422 	lcall	_delay
      00008F D0 07            [24]  423 	pop	ar7
                                    424 ;	led.c:8: i = i << 1;
      000091 8F 06            [24]  425 	mov	ar6,r7
      000093 EE               [12]  426 	mov	a,r6
      000094 2E               [12]  427 	add	a,r6
      000095 FF               [12]  428 	mov	r7,a
      000096 80 E8            [24]  429 	sjmp	00101$
      000098                        430 00104$:
                                    431 ;	led.c:10: }
      000098 22               [24]  432 	ret
                                    433 ;------------------------------------------------------------
      ...
      000099 7F 80            [12]  444 	mov	r7,#0x80
                                    445 ;	led.c:14: while (i != 0) {
      00009B                        446 00101$:
      00009B EF               [12]  447 	mov	a,r7
      00009C 60 14            [24]  448 	jz	00104$
                                    449 ;	led.c:15: P2 = 0xff & (~i);
      00009E EF               [12]  450 	mov	a,r7
      00009F F4               [12]  451 	cpl	a
      0000A0 F5 A0            [12]  452 	mov	_P2,a
                                    453 ;	led.c:16: delay(100);
      0000A2 90 00 64         [24]  454 	mov	dptr,#0x0064
      0000A5 C0 07            [24]  455 	push	ar7
      0000A7 12 00 62         [24]  456 	lcall	_delay
      0000AA D0 07            [24]  457 	pop	ar7
                                    458 ;	led.c:17: i = i >> 1;
      0000AC EF               [12]  459 	mov	a,r7
      0000AD C3               [12]  460 	clr	c
      0000AE 13               [12]  461 	rrc	a
      0000AF FF               [12]  462 	mov	r7,a
      0000B0 80 E9            [24]  463 	sjmp	00101$
      0000B2                        464 00104$:
                                    465 ;	led.c:19: }
      0000B2 22               [24]  466 	ret
                                    467 ;------------------------------------------------------------
      ...
      0000B3                        476 00102$:
                                    477 ;	led.c:23: pmd1();
      0000B3 12 00 7E         [24]  478 	lcall	_pmd1
                                    479 ;	led.c:24: pmd2();
      0000B6 12 00 99         [24]  480 	lcall	_pmd2
                                    481 ;	led.c:27: return 0;
                                    482 ;	led.c:28: }
      0000B9 80 F8            [24]  483 	sjmp	00102$
                                    484 	.area CSEG    (CODE)
                                    485 	.area CONST   (CODE)
                                    486 	.area XINIT   (CODE)
